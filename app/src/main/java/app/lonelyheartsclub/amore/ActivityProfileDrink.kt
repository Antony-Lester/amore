...
import app.lonelyheartsclub.amore.databinding.ActivityProfileDrinkBinding

class ActivityProfileDrink : AppCompatActivity() {
    override fun onCreate(savedInstanceState : Bundle?) {
        super.onCreate(savedInstanceState)
        ActivityInfo.SCREEN_ORIENTATION_PORTRAIT;supportActionBar?.hide()
        val binding  = ActivityProfileDrinkBinding.inflate(layoutInflater)
        ...
        binding.answerOne.setOnClickListener{
            Info.drink = "a";Fun.saveToInternalInfo();Fun.calculateIncreaseReputationScore(4.5f)
            ...
            if (Helper.swipePref){Helper.swipePref = false;binding.profileWidget.postDelayed({startActivity(Intent(this, ActivitySwipePrefDrink::class.java))}, 1600)}
        ...
        binding.answerTwo.setOnClickListener{
            Info.drink = "b";Fun.saveToInternalInfo()
        ...
        binding.answerThree.setOnClickListener{
            Info.drink = "c";Fun.saveToInternalInfo();Fun.calculateReduceReputationScore(3.0f)
        ...
        binding.answerFour.setOnClickListener{
            Info.drink = "d";Fun.saveToInternalInfo();Fun.calculateReduceReputationScore(17.0f)
