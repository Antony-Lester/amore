...
import app.lonelyheartsclub.amore.databinding.ActivityProfileEmploymentBinding

class ActivityProfileEmployment : AppCompatActivity() {
    override fun onCreate(savedInstanceState : Bundle?) {
        super.onCreate(savedInstanceState)
        ActivityInfo.SCREEN_ORIENTATION_PORTRAIT;supportActionBar?.hide()
        val binding  = ActivityProfileEmploymentBinding.inflate(layoutInflater)
        ...
        binding.answerOne.setOnClickListener{
            Info.employment = "a";Fun.saveToInternalInfo();Fun.calculateIncreaseReputationScore(15.0f)
            ...
            if (Helper.swipePref){Helper.swipePref = false; binding.profileWidget.postDelayed({startActivity(Intent(this, ActivitySwipePrefEmployment::class.java))}, 1600)}
        ...
        binding.answerTwo.setOnClickListener{
            Info.employment = "b";Fun.saveToInternalInfo();Fun.calculateIncreaseReputationScore(20.0f)
        ...
        binding.answerThree.setOnClickListener{
            Info.employment = "c";Fun.saveToInternalInfo();Fun.calculateIncreaseReputationScore(5.0f)
        ...
        binding.answerFour.setOnClickListener{
            Info.employment = "d";Fun.saveToInternalInfo();Fun.calculateIncreaseReputationScore(10.0f)
        ...
        binding.answerFive.setOnClickListener{
            Info.employment = "e";Fun.saveToInternalInfo();Fun.calculateReduceReputationScore(10.0f)
        ...
        binding.answerSix.setOnClickListener{
            Info.employment = "f";Fun.saveToInternalInfo();Fun.calculateReduceReputationScore(20.0f)
