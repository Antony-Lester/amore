...
import app.lonelyheartsclub.amore.databinding.ActivityProfileFoodBinding

class ActivityProfileFood : AppCompatActivity() {
    override fun onCreate(savedInstanceState : Bundle?) {
        super.onCreate(savedInstanceState)
        ActivityInfo.SCREEN_ORIENTATION_PORTRAIT;supportActionBar?.hide()
        val binding  = ActivityProfileFoodBinding.inflate(layoutInflater)
        ...
        binding.answerOne.setOnClickListener{
            Info.food = "a";Fun.saveToInternalInfo();Fun.calculateIncreaseReputationScore(5.0f)
            ...
            if (Helper.swipePref) {Helper.swipePref = false;binding.profileWidget.postDelayed({startActivity(Intent(this, ActivitySwipePrefFood::class.java))}, 1600)}
        ...
        binding.answerTwo.setOnClickListener{
            Info.food = "b";Fun.saveToInternalInfo()
        ...
        binding.answerThree.setOnClickListener{
            Info.food = "c";Fun.saveToInternalInfo();Fun.calculateReduceReputationScore(2.5f)
        ...
        binding.answerFour.setOnClickListener{
            Info.food = "d";Fun.saveToInternalInfo();Fun.calculateReduceReputationScore(5.5f)
        ...
        binding.answerFive.setOnClickListener{
            Info.food = "e";Fun.saveToInternalInfo();Fun.calculateReduceReputationScore(10.5f)
