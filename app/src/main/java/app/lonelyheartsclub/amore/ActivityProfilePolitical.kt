...
import app.lonelyheartsclub.amore.databinding.ActivityProfilePoliticalBinding

class ActivityProfilePolitical : AppCompatActivity() {
    override fun onCreate(savedInstanceState : Bundle?) {
        super.onCreate(savedInstanceState)
        ActivityInfo.SCREEN_ORIENTATION_PORTRAIT;supportActionBar?.hide()
        val binding  = ActivityProfilePoliticalBinding.inflate(layoutInflater)
        ...
        binding.answerOne.setOnClickListener{
            Info.political = "a";Fun.saveToInternalInfo();Fun.calculateIncreaseReputationScore(10.0f)
            ...
            if (Helper.swipePref){Helper.swipePref = false;binding.profileWidget.postDelayed({startActivity(Intent(this, ActivitySwipePrefPolitical::class.java))}, 1600)}
        ...
        binding.answerTwo.setOnClickListener{
            Info.political = "b";Fun.saveToInternalInfo();Fun.calculateIncreaseReputationScore(2.0f)
        ...
        binding.answerThree.setOnClickListener{
            Info.political = "c";Fun.saveToInternalInfo();Fun.calculateReduceReputationScore(2.0f)
        ...
        binding.answerFour.setOnClickListener{
            Info.political = "d";Fun.saveToInternalInfo();Fun.calculateReduceReputationScore(5.0f)
        ...
        binding.answerFive.setOnClickListener{
            Info.political = "e";Fun.saveToInternalInfo();Fun.calculateReduceReputationScore(1.0f)
        ...
        binding.answerSix.setOnClickListener{
            Info.political = "f";Fun.saveToInternalInfo();Fun.calculateReduceReputationScore(2.0f)
