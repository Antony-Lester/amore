...
import app.lonelyheartsclub.amore.databinding.ActivityProfileRelationshipBinding

class ActivityProfileRelationship : AppCompatActivity() {
    override fun onCreate(savedInstanceState : Bundle?) {
        super.onCreate(savedInstanceState)
        ActivityInfo.SCREEN_ORIENTATION_PORTRAIT;supportActionBar?.hide()
        val binding  = ActivityProfileRelationshipBinding.inflate(layoutInflater)
        ...
        binding.answerOne.setOnClickListener{
            Info.relationship = "a";Fun.saveToInternalInfo();Fun.calculateIncreaseReputationScore(20.0f)
            ...
            if (Helper.swipePref){Helper.swipePref = false;binding.profileWidget.postDelayed({startActivity(Intent(this, ActivitySwipePrefRelationship::class.java))}, 1600)}
        ...
        binding.answerTwo.setOnClickListener{
            Info.relationship = "b";Fun.saveToInternalInfo();Fun.calculateReduceReputationScore(15.0f)
        ...
        binding.answerThree.setOnClickListener{
            Info.relationship = "c";Fun.saveToInternalInfo();Fun.calculateReduceReputationScore(30.0f)
        ...
        binding.answerFour.setOnClickListener{
            Info.relationship = "d";Fun.saveToInternalInfo();Fun.calculateReduceReputationScore(10.0f)
        ...
        binding.answerFive.setOnClickListener{
            Info.relationship = "e";Fun.saveToInternalInfo();Fun.calculateIncreaseReputationScore(10.0f)
        ...
        binding.answerSix.setOnClickListener{
            Info.relationship = "f";Fun.saveToInternalInfo();Fun.calculateReduceReputationScore(10.0f)
