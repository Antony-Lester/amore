...
import app.lonelyheartsclub.amore.databinding.ActivityProfileReligionBinding

class ActivityProfileReligion : AppCompatActivity() {
    override fun onCreate(savedInstanceState : Bundle?) {
        super.onCreate(savedInstanceState)
        ActivityInfo.SCREEN_ORIENTATION_PORTRAIT;supportActionBar?.hide()
        val binding  = ActivityProfileReligionBinding.inflate(layoutInflater)
        ...
        binding.answerOne.setOnClickListener{
            Info.religion = "a";Fun.saveToInternalInfo()
            ...
            if (Helper.swipePref){Helper.swipePref = false;binding.profileWidget.postDelayed({startActivity(Intent(this, ActivitySwipePrefReligion::class.java))}, 1600)}
        ...
        binding.answerTwo.setOnClickListener{
            Info.religion = "b";Fun.saveToInternalInfo();Fun.calculateReduceReputationScore(4.5f)
        ...
        binding.answerThree.setOnClickListener{
            Info.religion = "c";Fun.saveToInternalInfo();Fun.calculateIncreaseReputationScore(10.5f)
        ...
        binding.answerFour.setOnClickListener{
            Info.religion = "d";Fun.saveToInternalInfo()
        ...
        binding.answerFive.setOnClickListener{
            Info.religion = "e";Fun.saveToInternalInfo()
        ...
        binding.answerSix.setOnClickListener{
            Info.religion = "f";Fun.saveToInternalInfo()
