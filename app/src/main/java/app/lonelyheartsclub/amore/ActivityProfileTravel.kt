...
import app.lonelyheartsclub.amore.databinding.ActivityProfileTravelBinding

class ActivityProfileTravel : AppCompatActivity() {
    override fun onCreate(savedInstanceState : Bundle?) {
        super.onCreate(savedInstanceState)
        ActivityInfo.SCREEN_ORIENTATION_PORTRAIT;supportActionBar?.hide()
        val binding  = ActivityProfileTravelBinding.inflate(layoutInflater)
        ...
        binding.answerOne.setOnClickListener{
            Info.travel = "a";Fun.saveToInternalInfo();Fun.calculateReduceReputationScore(10.0f)
            ...
            if (Helper.swipePref){Helper.swipePref = false;binding.profileWidget.postDelayed({startActivity(Intent(this, ActivitySwipePrefTravel::class.java))}, 1600)}
        ...
        binding.answerTwo.setOnClickListener{
            Info.travel = "b";Fun.saveToInternalInfo()
        ...
        binding.answerThree.setOnClickListener{
            Info.travel = "c";Fun.saveToInternalInfo();Fun.calculateIncreaseReputationScore(5.5f)
